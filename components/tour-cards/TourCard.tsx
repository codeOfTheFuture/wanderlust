...
const TourCard: FC<Props> = ({ tour }) => {
	...
	const handleClick = () => {
		if (user?._id.toString() === guideId && router.pathname === "/offered-tours") {
	...
	const tourFavorite = user?.favoriteTours.find((t: Tour) => t._id === tour._id) != null;
	...
	return (
		...
		>
			...
			>
				...
				{user?._id.toString() === guideId && router.pathname === "/offered-tours" ? (
