...
const TourCards: FC<Props> = ({ loading }) => {
	...
	return (
		<div
			className={`${
				router.pathname === "/search" && "justify-between h-[100vh] p-4 mt-20 lg:mt-0"
			} flex flex-col w-full mx-auto bg-white relative ${
		...
		>
			...
			<div
				className={`grid ${
					router.pathname === "/search" ? "lg:grid-cols-2 mt-16" : "lg:grid-cols-3 xl:grid-cols-4"
